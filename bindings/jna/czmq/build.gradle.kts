...
publishing {
    publications.withType<MavenPublication> {
        ...
        pom {
            name.set("czmq")
            description.set("The high-level C binding for 0MQ")
            url.set("https://github.com/zeromq/czmq")
            ...
            scm {
                connection.set("https://github.com/zeromq/czmq.git")
                developerConnection.set("https://github.com/zeromq/czmq.git")
                url.set("https://github.com/zeromq/czmq")
            }
        }
    }
