...
#   Build Jar for JVM
TERM=dumb $CI_TIME ./gradlew jvmJar ${GRADLEW_OPTS[@]} ${CZMQ_GRADLEW_OPTS} $IS_RELEASE

#   Build Aar for Android
TERM=dumb $CI_TIME ./gradlew assemble ${GRADLEW_OPTS[@]} ${CZMQ_GRADLEW_OPTS} $IS_RELEASE
